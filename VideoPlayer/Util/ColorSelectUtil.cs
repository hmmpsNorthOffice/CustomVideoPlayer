...
namespace CustomVideoPlayer.Util
{
	...
	class ScreenColorUtil
    {
     ...
     //   internal static Color _screenColorOff = Color.clear;
        ...
        public enum ScreenColorEnum { White, Red, Lime, Blue, Yellow, Cyan, Majenta, Silver, Gray, Maroon, Olive, Green, Purple, Teal, Navy, screenColorOn, screenColorOff };

        private static readonly Color _WHITE = new Color32(255, 255, 255, 255);  // old _screenOn used 0 alpha ...
